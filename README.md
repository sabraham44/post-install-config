...
<p>
Now that we have successfully configured osTicket, we will do some system administration and work on some post installation setup.
The first step is to configure new roles within the help desk, to complete this go to Admin panel-> Agents-> Roles. We will create a Supreme Admin. 
Click on "Add new role" then enter the name of the new role. You can also modify any specific roles permissions. In this case since we are creating a Supreme Admin, the user will be given all permissions. Keep in mind roles are used to determine an agents permissions so not all agents will have unlimited access. If you followed the steps correctly your screen should like something like this. As you can see we have successfully created the "Supreme Admin" role.
</p>
...
<br />
<img src="https://user-images.githubusercontent.com/126641333/223578684-f6ffdd03-57a4-45c4-83fa-7fb2ed558a09.png"/>
</p>
<p>
